...
def test_llr_scr_success_updates_memory_and_preserves_carry_sign() -> None:
...
def test_overlapping_store_invalidates_llr_reservation(interfering_store: str) -> None:
    observed = run_program_source(
        f'LLR R14, R3\n{interfering_store}\nSCR R14, R1\nSTOP',
