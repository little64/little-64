...
Typical usage::
    ...
    hdl/tools/arty_ila.py insert --preset internal-bus

    # Program the board and run a capture with a simple trigger:
    hdl/tools/arty_ila.py capture --preset internal-bus \
        --trigger 'lsu_bus_watchdog_timeout=1'

    # Discover candidate net names when building a new preset:
    hdl/tools/arty_ila.py list-nets --filter '*watchdog*' --filter '*i_bus*cyc*'
...
_HEADER = """# Auto-generated by hdl/tools/arty_ila.py. Do not edit by hand.
